...
//           {/* Add state for the preferred password */}
//           <input
//             type="password"
//             placeholder="Enter preferred password"
//             className="w-full p-2 mt-2 border border-gray-300 rounded-md"
//             value={preferredPassword}
//             onChange={(e) => setPreferredPassword(e.target.value)} // Update the password state
//           />
...
import axios from 'axios';
import { Chart, registerables } from 'chart.js';
import { handleChangePassword } from '../../services/adminServices'; // Make sure to import the function
...
function About() {
  ...
  const handlePasswordSubmit = async () => {
    // Call the handleChangePassword function
    if (!preferredPassword) {
      setMessage('Please enter a new password');
      return;
    }

    await handleChangePassword(fullName, preferredPassword, setMessage);
    setPreferredPassword(''); // Clear input field after submission
  };
