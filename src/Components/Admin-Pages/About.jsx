...
import { handlePasswordChangeRequest } from '../../services/adminServices'; // Correct import
...
function About() {
  ...
  const handlePasswordSubmit = async () => {
    // Call the handlePasswordChangeRequest function
    if (!preferredPassword) {
      setMessage('Please enter a new password');
      return;
    }

    await handlePasswordChangeRequest(fullName, preferredPassword, setMessage); // Correct service call
