            ...
            <div>
              ...
              <div className="relative">
                <button
                  ...
                  className="group flex items-center w-full px-4 py-2 text-lg font-medium text-white hover:bg-gray-200"
                >
                  <FaUserFriends className=" h-5 w-5 text-white group-hover:text-gray-500" />
                  Employee Management <FaCaretDown className="ml-auto" />
                </button>{" "}
                {isEmployeeDropdownOpen && (
                  <div className="pl-8 mt-2 space-y-1">
                    <Link
                      to="create-admin"
                      className="group flex items-center px-4 py-2 text-lg font-medium text-gray-400 hover:bg-gray-200"
                    >
                      Create Admin{" "}
                    </Link>{" "}
                    <Link
