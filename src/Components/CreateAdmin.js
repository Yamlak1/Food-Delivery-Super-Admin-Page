...
import Sidebar from "./SuperAdminSidebar"; // Ensure Sidebar is imported
...
export default function CreateAdmin() {
  ...
  return (
    <div className="flex min-h-screen">
      <div
        className={`flex flex-col items-center justify-center flex-1 transition-all duration-300 ease-in-out ${
          isSidebarOpen ? "ml-64 md:ml-80" : ""
        }`}
      >
